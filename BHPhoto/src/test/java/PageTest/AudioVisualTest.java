...
public class AudioVisualTest extends AudioVisual {
    ...
    @BeforeMethod
    public void init() {
        audioVisual = PageFactory.initElements(webDriver, AudioVisual.class);
    }
    @Test
    public void fiftyTest() throws InterruptedException {
    TestLogger.log(getClass().getSimpleName() + ": " + CommonAPI.convertToString(new Object() {
    }.getClass().getEnclosingMethod().getName()));
//    menuAudioVisual.clickOnAudioVisualProjectors();
    }
    @Test
    ...
    @Test
    public void fiftytwoTest() throws InterruptedException {
    TestLogger.log(getClass().getSimpleName() + ": " + CommonAPI.convertToString(new Object() {
    }.getClass().getEnclosingMethod().getName()));
        audioVisual.clickOnAudioVisualCommercialMonitorsDisplays();
    }
    @Test
    public void fiftythreeTest() throws InterruptedException {
    TestLogger.log(getClass().getSimpleName() + ": " + CommonAPI.convertToString(new Object() {
    }.getClass().getEnclosingMethod().getName()));
    audioVisual.clickOnAudioVisualVideoPresentersAccessories();
    }
    @Test
    public void fiftyfourTest() throws InterruptedException {
    TestLogger.log(getClass().getSimpleName() + ": " + CommonAPI.convertToString(new Object() {
    }.getClass().getEnclosingMethod().getName()));
    audioVisual.clickOnAudioVisualWhiteboardsEasels();
    }
    @Test
    public void testHoverOverAudioVisual() throws InterruptedException {
        audioVisual.hoverOverAudioVisualElement();
